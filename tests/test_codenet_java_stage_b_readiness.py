...
def test_current_stage_b_design_passes_scientific_checks_and_fails_only_on_freeze_state() -> None:
    ...
    assert set(report["blocking_failures"]) == {
        "immutable_implementation_commit",
        "container_digest",
